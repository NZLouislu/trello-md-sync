...
- ✅ **Runnable examples:** Complete examples in the `src/trello/` directory
...
npm run md-to-trello -- md/multi-story.md

# Export Trello to markdown  
npm run trello-to-md

# Preview changes (dry-run)
npm run md-to-trello -- md/multi-story.md --dry-run
```
...
# Export single story
npm run trello-to-md -- Story-1234
...
LOG_LEVEL=debug npm run md-to-trello

# Preview changes without executing
npm run md-to-trello -- stories/my-stories.md --dry-run
```

### Using trello:story

```bash
npm run trello-to-md:story -- Story-1234
```
...
```bash
npm run trello-to-md -- Story-0456
npm run trello-to-md ./stories/out-story -- Story-0112
```
